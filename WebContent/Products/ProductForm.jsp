    ...
    <div class="container-fluid">
      <div class="container">
        <div class="my-3 d-flex justify-content-between">
          <h1>New Product</h1>
          <a href="Products.jsp" class="btn btn-primary">Save</a>
        </div>
        ...
        <div class="table-responsive">
          ...
          <form action="">
            ...
            <div class="input-group flex-nowrap my-1">
              ...
              <input type="text" class="form-control" placeholder="Stock Quantity" aria-label="Username" aria-describedby="addon-wrapping">
            </div>
          </form>
